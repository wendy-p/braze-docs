...
Note that a company may run at most one export per segment using this endpoint at a given time. Please wait before your export completes before retrying. 
