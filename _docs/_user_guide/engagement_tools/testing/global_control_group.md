...
__Calculation__<br>
Total events for treatment - total events scaled for control
##### Incremental Lift (Percentage)
The percentage of your treatment’s total events that can be attributed to your treatment (versus natural user behavior) - this is calculated by dividing incremental uplift (number) by the total number of events scaled for your treatment group 
